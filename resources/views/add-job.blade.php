          ...
          <div class="card">
            ...
            <div class="card-body">
                ...
                <div class="col-sm-12 col-md-7">
                    ...
                    <div class="form-group row mb-4">
                        <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Petugas 2</label>
                            <div class="col-sm-12 col-md-7">
                             <input type="text" class="form-control">
                            </div>
                    </div>
                    ...
                    <div class="form-group row mb-4">
                        <label class="col-form-label text-md-right col-12 col-md-3 col-lg-3">Petugas 3</label>
                            <div class="col-sm-12 col-md-7">
                             <input type="text" class="form-control">
                            </div>
                    </div>
